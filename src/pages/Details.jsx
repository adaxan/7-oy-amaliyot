        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="flex-1">
            <img
              ...
              className="w-full h-2/3 rounded-lg object-cover shadow-lg"
            />
          </div>
          <div className="flex-1 space-y-6">
            <h1 className="text-3xl font-bold text-gray-400">{product.attributes.title}</h1>
            <h2 className="text-2xl text-gray-500">${product.attributes.price}</h2>
            ...
            <div>
              ...
              <select value={count} onChange={(e) => { setCount(Number(e.target.value)) }} className="w-40 py-3 px-2 border border-gray-300 rounded-lg">
                <option>1</option>
                <option>2</option>
                <option>3</option>
                <option>4</option>
